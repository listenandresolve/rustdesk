...
def customize_files():
    ...
    process_file(
        ...
        replacement=r'pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.polartang.it"];',
    ...
    process_file(
        ...
        replacement=r'pub const RS_PUB_KEY: &str = "ANbm8MxNJjzjwlL4rKhui+CVi8rP9adTRqr9wl0V2kM=";',
